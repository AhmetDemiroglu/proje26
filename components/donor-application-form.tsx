...
import { ArrowLeft, Check, HeartHandshake, LoaderCircle, ShieldCheck } from "lucide-react";
...
export function DonorApplicationForm() {
  ...
  if (status === "success") {
    return (
      <main className="content-page donor-page">
        <section className="donor-success">
          ...
          <p>
            Başvurun yönetim panelindeki inceleme kuyruğuna eklendi. Kimlik ve
            destek koşulları doğrulandıktan sonra e-posta ile iletişime
            geçeceğiz.
          </p>
  ...
  return (
    <main className="content-page donor-page">
      ...
      <div className="donor-heading">
        ...
        <p>
          Bireysel veya kurumsal destekçi başvuruları önce doğrulanır. Öğrenci
          iletişim bilgileri, öğrencinin belirli eşleşmeye ayrıca onayı olmadan
          paylaşılmaz.
        </p>
      </div>

      <form className="donor-form content-card" onSubmit={submit}>
        <fieldset>
